...
namespace ZincOxide.Exceptions {
	...
	public class ZincOxideException : Exception {
		...
		#region Constructors
		/// <summary>
		/// Initializes a new instance of the <see cref="ZincOxideException"/> class without specifying a message or reason.
		/// </summary>
		public ZincOxideException () : base () {
		}

		/// <summary>
		/// Initializes a new instance of the <see cref="ZincOxideException"/> class with a message explaining the error.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ZincOxideException"/> class. With a parameteric message.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ZincOxideException"/> class. With serialization and streaming info.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ZincOxideException"/> class with a message explaining the error and another Exception that caused that exception.
		/// </summary>
