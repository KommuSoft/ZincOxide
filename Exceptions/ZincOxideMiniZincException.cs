...
namespace ZincOxide.Exceptions {
	...
	/// <summary>
	/// A <see cref="ZincOxideException"/> that is thrown when the input is not valid MiniZinc.
	/// </summary>
	public class ZincOxideMiniZincException : ZincOxideException {

		/// <summary>
		/// Initializes a new instance of the <see cref="ZincOxideMiniZincException"/> class without specifying a message or reason.
		/// </summary>
		public ZincOxideMiniZincException () : base () {
		}

		/// <summary>
		/// Initializes a new instance of the <see cref="ZincOxideMiniZincException"/> class with a message explaining the error.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ZincOxideMiniZincException"/> class. With a parameteric message.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ZincOxideMiniZincException"/> class. With serialization and streaming info.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ZincOxideMiniZincException"/> class with a message explaining the error and another Exception that caused that exception.
		/// </summary>
