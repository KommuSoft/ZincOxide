...
namespace ZincOxide.Exceptions {
	...
	/// <summary>
	/// A <see cref="ZincOxideException"/> class that is called when a references does not correspond to any defined object.
	/// </summary>
	public class ZincOxideNameNotFoundException : ZincOxideException {

		/// <summary>
		/// Initializes a new instance of the <see cref="ZincOxideNameNotFoundException"/> class without specifying a message or reason.
		/// </summary>
		public ZincOxideNameNotFoundException () : base () {
		}

		/// <summary>
		/// Initializes a new instance of the <see cref="ZincOxideNameNotFoundException"/> class with a message explaining the error.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ZincOxideNameNotFoundException"/> class. With a parameteric message.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ZincOxideNameNotFoundException"/> class. With serialization and streaming info.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ZincOxideNameNotFoundException"/> class with a message explaining the error and another Exception that caused that exception.
		/// </summary>
