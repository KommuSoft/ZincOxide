...
namespace ZincOxide {
	...
	/// <summary>
	/// The root of all exceptions that can be thrown by the ZincOxide system.
	/// </summary>
	public class ZincOxideException : Exception {
		/// <summary>
		/// Initializes a new instance of the <see cref="ZincOxide.ZincOxideException"/> class without specifying a message or reason.
		/// </summary>
		public ZincOxideException () : base () {
		}

		/// <summary>
		/// Initializes a new instance of the <see cref="ZincOxide.ZincOxideException"/> class with a message explaining the error.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ZincOxide.ZincOxideException"/> class. With a parameteric message.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ZincOxide.ZincOxideException"/> class. With serialization and streaming info.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ZincOxide.ZincOxideException"/> class with a message explaining the error and another Exception that caused that exception.
		/// </summary>
